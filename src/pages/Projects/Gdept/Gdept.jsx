        ...
        <div class="flex flex-col lg:flex-row flex-wrap flex-wrap-reverse">
          ...
          <div className="text-lg lg:w-3/5 text-gray-500">
            ...
            <p>
              ...
              <a
                href="https://www.sdis57.fr/"
                className="text-[#62B9CB] hover:text-[#5FACD3]"
              >
                SDIS57
              </a>
              , j'ai mené diverses missions dont le développement d'une
              application web sur la gestion des gardes de commandement.
              <br />
              <br />
              ...
              <br />
              Cette application offre une interface permettant aux bénéficiaire
              de planifier, suivre et gérer efficacement les gardes de
              commandement. Elle intègre des fonctionnalités telles que la
              création de plannings, la gestion des disponibilités du personnel,
            ...
            <p>
              Afin d'unifier tous les développements internes, le Département du
              Numérique du SDIS57 a décidé d'utiliser le framework Javascript
              SvelteKit car il présente:
            </p>
