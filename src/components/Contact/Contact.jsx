                ...
                <h2 className="text-base font-semibold bg-[#EAF9FC] rounded p-1 text-[#5FACD3] inline-block">Me contacter</h2>
                    ...
                    <dl className="grid grid-cols-1 gap-x-8 gap-y-16 lg:grid-cols-3">
                        <div className="flex items-center ms:mx-auto">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 text-[#62B9CB] inline-block">
                                <path strokeLinecap="round" d="M16.5 12a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0zm0 0c0 1.657 1.007 3 2.25 3S21 13.657 21 12a9 9 0 10-2.636 6.364M16.5 12V8.25" />
                            </svg>
                            <div className="ms-10 flex max-w-xs flex-col gap-y-4">
                                <a href="mailto:contact@romain-gilot.fr" className="text-2xl  tracking-tight text-gray-900">contact@romain-gilot.fr</a>
                                <dd className="order-first text-gray-600">
                                    Email
                                </dd>
                            </div>
                        </div>
                        <div className="flex items-center ms:mx-auto">
                            ...
                            <div className="ms-10 flex max-w-xs flex-col gap-y-4">
                                <a href="" className="text-2xl  tracking-tight text-gray-900">www.romain-gilot.fr</a>
                                <dd className="order-first text-gray-600">
                                    Site web
                                </dd>
                            </div>
                        ...
                        <div className="flex items-center ms:mx-auto">
                            ...
                            <div className="ms-10 flex max-w-xs flex-col gap-y-4">
                                ...
                                <dd className="text-gray-600 order-first">
                                    Lieu
                                </dd>
                            </div>
                        </div>
